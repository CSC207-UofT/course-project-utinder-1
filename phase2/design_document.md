...
| Justin Cha |  |
| Aaditya Mandal  | |
| Michael Rubenstein  | The pull request that I'm proud of is https://github.com/Bantonio12/Utinderlogin/pull/6 in which Kex and I refactored the entire Post class to make it adhere better to Clean Architecture, deleted useless code , changed the Java Docs and added more unit tests. |
